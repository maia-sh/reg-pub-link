...
After updating registry data, we reapplied the IntoValue exclusion criteria: completion date before 2009 or after 2017, non-interventional, incomplete based on study status, non-German-UMC lead. See @riedel2021c for further details on these criteria. We limited our sample to trials with results with a PMID and full-text publication.
