...
Data collection, preparation, and analysis was performed in `r r_citation`<!--#aside from parsing PDFs to XML in Python-->.<!--#Additional packages and libraries are specified in the methods.--> Code to recreate the analysis dataset, rerun the analysis, and generate this manuscript is available at <https://github.com/maia-sh/reg-pub-link>. Raw data (with the exception of the full-text of publications) is available at <https://github.com/maia-sh/intovalue-data>. A STROBE checklist for reporting cross-sectional studies in provided in the Supplement.
