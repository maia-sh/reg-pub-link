...
example_journals <- "
Taylor & Francis extracts TRNs from the abstract and full-text, submit this metadata to CrossRef and Pubmed, and displays the linked trial via Crossmark on the article page [@taylorfrancisgroup2020; @crossref2020c])
"
...
example_pubmed <- "
The National Library of Medicine relies on publisher-provided data and manual indexers to create the TRN PubMed metadata if the TRN appears in the abstract or full-text. Our study shows this manual-only strategy misses TRNs and could be semi-automated to detect more TRNs for manual verfication.
"
